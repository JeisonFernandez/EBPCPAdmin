...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logo.png', 15, 8, 20); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      $this->SetFont('Arial', 'B', 19); //tipo fuente, negrita(B-I-U-BIU), tamañoTexto
      $this->Cell(45); // Movernos a la derecha
      $this->SetTextColor(0, 0, 0); //color
      //creamos una celda o fila
      $this->Cell(110, 15,'EBPCP Admin', 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      $this->Cell(70, 10, 'CORREO', 1, 0, 'C', 1);
      $this->Cell(25, 10, 'ROL', 1, 0, 'C', 1);
      $this->Cell(55, 10, 'ESTADO', 1, 0, 'C', 1);
      $this->Ln(10);
   }
