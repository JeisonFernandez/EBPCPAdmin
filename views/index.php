                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" id="frmLogin" autocomplete="off">

                                            <div class="form-group">
                                                <label for="usuario"><i class="fas fa-user ml-1"></i> Usuarios <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control form-control-user" id="usuario" name="usuario" placeholder="Ingresar Usuario...">
                                            </div>

                                            <div class="form-group">
                                                <label for="clave"><i class="fas fa-key ml-1"></i> Contraseña <span class="text-danger">*</span></label>
                                                <input type="password" class="form-control form-control-user" id="clave" name="clave" placeholder="Ingresar Contraseña...">
                                            </div>
